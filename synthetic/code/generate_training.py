...
if __name__ == "__main__":
    ...
    parser.add_argument("--outfolder", type=str, default=osp.join(cfg.base_path_train, "soundscapes_generated"))
    parser.add_argument("--outcsv", type=str, default=osp.join(cfg.base_path_train, "synthetic_generated.csv"))
    parser.add_argument("--fgfolder", type=str, default=osp.join(cfg.base_path_train, "soundbank", "foreground"))
    parser.add_argument("--bgfolder", type=str, default=osp.join(cfg.base_path_train, "soundbank", "background"))
