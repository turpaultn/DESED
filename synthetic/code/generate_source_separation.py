...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_folder', type=str, default=osp.join(cfg.audio_path_eval, 'soundscapes_generated_ss'))
    parser.add_argument('--out_tsv', type=str,
                        default=osp.join(cfg.meta_path_eval, "soundscapes_generated_ss", "XdB.tsv"))
