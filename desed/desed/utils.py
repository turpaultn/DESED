...
def post_processing_df_annotations(df, files_duration=None, output_tsv=None, min_dur_event=0.250,
    ...
    """ clean the .txt files of each file. It is the same processing as the real data
        ...
        Args:
            ...
            files_duration: pd.DataFrame or float, dataframe containing columns ["filename", "duration"] indicating the lengh of a file.
    ...
    for fn in df.filename.unique():
        ...
        if files_duration is not None:
            if type(files_duration) is pd.DataFrame:
                ...
                TypeError("files duration is pd.DataFrame or a float only")
        else:
            length_sec = None
...
def post_processing_txt_annotations(txtdir, wavdir=None, output_folder=None, output_tsv=None, min_dur_event=0.250,
...
if __name__ == '__main__':
    ...
    post_processing_txt_annotations("/Users/nturpaul/Documents/Seafile/DCASE/Desed_synthetic/training/soundscapes_generated",
